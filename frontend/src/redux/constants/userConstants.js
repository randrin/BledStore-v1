...
export const USER_LIST_TOP_SELLER_REQUEST = "USER_LIST_TOP_SELLER_REQUEST";
export const USER_LIST_TOP_SELLER_SUCCESS = "USER_LIST_TOP_SELLER_SUCCESS";
export const USER_LIST_TOP_SELLER_FAIL = "USER_LIST_TOP_SELLER_FAIL";
